...
const LEGAL_PAGES = {
  privacy: {
    ...
    introduction: 'With Mama Doula respects your privacy and is committed to handling personal information with care.',
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Please avoid including sensitive health information in the website contact form. Any information you choose to share is provided voluntarily.',
        ],
      },
      {
  ...
  terms: {
    title: 'Terms of Use',
    updated: '18 July 2026',
    introduction: 'These terms set out the conditions for using the With Mama Doula website.',
    sections: [
      {
  ...
  return (
    <main className="legal-page">
      <div className="container legal-page-inner">
        <a className="legal-page-home" href="/" aria-label={`Return to ${siteContent.brand.name}`}>
          {siteContent.brand.name}
        </a>
        <header className="legal-page-header">
          <span className="eyebrow">With Mama Doula</span>
          <h1>{content.title}</h1>
